            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    ...
                    if ($total > 0) {
                        ...
                        $sql .= "	Where	1 = 1 ";
                        $sql .= $addSql;
                        $sql .= "	Order by b.prior DESC,	b.idx Desc ";
                                    ...
                                    <td style="padding:0;">
                                        <ul style="width:40px;margin:0 auto;padding:0;list-style:none;">
                                            <li style="float:left;width:20px;height:12px;text-align:center;"><a
                                                    href="bbs_save.php?code=<?= $code ?>&mode=prior&posi=upup&idx=<?= $row[$i]['idx'] ?>&prior=<?= $row[$i]['prior'] ?>&page=<?= $page ?>"><img
                                                        src="../img/upup_icon.gif" border="0" alt="10단계 위로"></a></li>
                                            <li style="float:left;width:20px;height:12px;text-align:center;"></li>
                                            <li style="float:left;width:20px;height:12px;text-align:center;"><a
                                                    href="bbs_save.php?code=<?= $code ?>&mode=prior&posi=up&idx=<?= $row[$i]['idx'] ?>&prior=<?= $row[$i]['prior'] ?>&page=<?= $page ?>"><img
                                                        src="../img/up_icon.gif" border="0" alt="1단계 위로"></a></li>
                                            <li style="float:left;width:20px;height:12px;text-align:center;"><a
                                                    href="bbs_save.php?code=<?= $code ?>&mode=prior&posi=down&idx=<?= $row[$i]['idx'] ?>&prior=<?= $row[$i]['prior'] ?>&page=<?= $page ?>"><img
                                                        src="../img/down_icon.gif" border="0" alt="1단계 아래로"></a></li>
                                            <li style="float:left;width:20px;height:12px;text-align:center;"></li>
                                            <li style="float:left;width:20px;height:12px;text-align:center;"><a
                                                    href="bbs_save.php?code=<?= $code ?>&mode=prior&posi=downdown&idx=<?= $row[$i]['idx'] ?>&prior=<?= $row[$i]['prior'] ?>&page=<?= $page ?>"><img
